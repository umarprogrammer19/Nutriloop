                ...
                <div className="relative 2xl:max-w-360 w-[90%] mx-auto px-0 sm:px-6">
                    ...
                    <div className="relative z-20 mt-4 flex items-center justify-between rounded-full border border-white/10 bg-black/30 backdrop-blur-xl px-5 sm:px-6 py-2 sm:py-1">
                        ...
                        <button
                            ...
                            className="hidden md:flex items-center rounded-full bg-green-500 px-6 py-2 text-black font-semibold hover:bg-green-400 transition"
                        >
                            Give Review
                        </button>
                    ...
                    >
                        <div className="flex flex-col px-6 gap-5">
                            ...
                            <button
                                onClick={() => { setIsOpen(false); setShowReview(true); }}
                                className="w-full text-center rounded-full bg-green-500 px-6 py-3 text-black font-semibold hover:bg-green-400 transition mt-1"
                            >
                                Give Review
                            </button>
                        </div>
