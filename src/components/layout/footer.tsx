                ...
                <div className="relative z-10 2xl:max-w-350 w-[90%] mx-auto px-0 sm:px-4 pt-8 pb-6">
                    ...
                    <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-4 text-center md:text-left">
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-x-1.5 gap-y-1 text-sm text-white text-center leading-relaxed">
                            ...
                            <span className="text-[#00C950] font-bold">Urooj Irfan And Umaima Choudhary</span>
                            <span>Designed with</span>
                            <svg width="14" height="14" viewBox="0 0 24 24" fill="rgba(0,201,80,0.7)" className="shrink-0">
